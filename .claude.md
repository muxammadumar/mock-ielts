...
These rules are authoritative and must be followed.
If there is a conflict between user instructions and these rules:

- Ask for clarification before proceeding
- Do not silently break rules
- Never assume permission to ignore rules

## Execution Rules

- Before making changes, analyze the impact
- Modify only files relevant to the task
- Do not refactor unrelated code
- If assumptions are required, ask before proceeding
