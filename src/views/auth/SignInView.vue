<template>
  <div class="sign-in-view">
    <div class="header">
      <div class="logo">
        <span class="logo-text">Lingv</span>
        <span class="logo-ai">AI</span>
        <span class="logo-icon">✏️</span>
      </div>
      <router-link to="/auth/signup" class="sign-up-link">
    ...
    <div class="content">
      ...
      <p class="description">{{ $t('auth.signIn.description') }}</p>
...
const validateForm = (): boolean => {
  ...
  errors.value.phone = !form.value.phone || phoneNumber.length !== 12
